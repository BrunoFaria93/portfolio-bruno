...
const Work = () => {
  return (
    ...
    //           >
    //             <span className="text-3xl text-black">Bruno's Hotel</span>
    //           </div>
    //         </div>
    //         <div className="group relative border-2 border-white/50 rounded-xl h-auto overflow-hidden">
    //           <a
    ...
    //              transition-all duration-700 z-50"
    //           >
    //             <span className="text-3xl text-black">BlitzBee - Rede Social</span>
    //           </div>
    //         </div>
    //         <div className="group relative border-2 border-white/50 rounded-xl h-auto overflow-hidden">
    //           <a
    ...
    //              transition-all duration-700 z-50"
    //           >
    //             <span className="text-3xl text-black">Chat</span>
    //           </div>
    //         </div>
    //       </motion.div>
    //     </div>
